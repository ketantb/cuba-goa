        ...
        <div className='quba-goa-search'>
          ...
          <div className='about-hotel'>
            ...
            {ourPropertiesData[0] && <div className='overview-of-rooms'>
              <div className='room-title'><h2> {ourPropertiesData.find((el) => el.resortName === selectedValue[0])?.resortName + " ROOMS"}</h2></div>
              {ourPropertiesData.find((el) => el.title === selectedValue[0]).rooms?.map((el) =>
                <>
